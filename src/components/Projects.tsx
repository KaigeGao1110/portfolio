...
const projects = [
  ...
  {
    slug: 'briefverify', title: 'BriefVerify', subtitle: 'Legal Citation Verification',
    description: 'AI-powered legal citation verification tool that checks existence, accuracy, and good-law status of every citation in a legal brief. LLM-powered proposition mismatch detection compares brief claims against actual case holdings, with confidence-scored results delivered in under 30 seconds.',
    tags: ['Next.js', 'Supabase', 'Claude API', 'CourtListener', 'Stripe', 'Cloudflare'],
    url: 'https://briefverify.com',
    github: 'https://github.com/KaigeGao1110/citation-verifier',
    stats: ['6M+ Parentheticals', 'Good Law Check', 'REST API + MCP', 'Vercel Deployed'],
    features: [
      { title: 'Good Law + Proposition Check', desc: 'Detects overturned/reversed/abrogated cases; LLM scores brief propositions vs actual holdings with 🟢🟡🔴 confidence' },
      { title: '6M+ Treatment Classification', desc: 'Full-scale LLM classification of 6M+ legal parenthetical records across 10 treatment categories using multi-model parallel inference' },
      { title: 'REST API + MCP Server', desc: '/api/v1/verify endpoint with API key auth and rate limiting; MCP server for AI tool integration into legal drafting workflows' },
      { title: 'Full-Stack Production', desc: 'Clerk auth, Sentry monitoring, Stripe metered billing, Vercel auto CI/CD — production-ready with 137+ passing tests' },
    ],
  },
  {
